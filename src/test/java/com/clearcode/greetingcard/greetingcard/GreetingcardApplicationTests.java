package com.clearcode.greetingcard.greetingcard;
  ...
  public void contextLoads() {
    ...
    for (Greeting greeting : greetings) {
      ...
      for (int i = 0; i < length / 11; i++) {
        if (i == 0) {
          System.out.println("    " + message.substring(index, 9));
        } else {
          System.out.println(message.substring(index, (i + 1) * 11));
        }
        index += 11;
      }
      System.out.println(message + "==" + message.length());
    }
    System.out.println(JsonMapper.DEFAULT.toJson(greetings));
  }
